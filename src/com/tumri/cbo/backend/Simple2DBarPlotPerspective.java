...
public class Simple2DBarPlotPerspective extends GraphPerspective {

    public static Simple2DBarPlotPerspective PERSPECTIVE =
	                    new Simple2DBarPlotPerspective();

    private Simple2DBarPlotPerspective()
    {
        super("2D bar plot", 4);
    }
    ...
    public static void emit2DBarPlot
	...
	throws IOException
    {
        if(Graph.isOneDGraph(x))
        {
            ...
            emit2DBarPlot(stream, "", xPoints, yPoints,
