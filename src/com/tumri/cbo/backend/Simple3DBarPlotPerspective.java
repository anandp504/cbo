...
public class Simple3DBarPlotPerspective extends GraphPerspective {

    public static Simple3DBarPlotPerspective PERSPECTIVE =
	                    new Simple3DBarPlotPerspective();

    private Simple3DBarPlotPerspective()
    {
        super("3D bar plot", 5);
    }
    ...
    public static void emit3DBarPlot
	...
	throws IOException
    {
        if(isThreeDGraphP(x))
        {
            ...
            emit3DBarPlot(stream, "", xPoints, yPoints, zPoints,
